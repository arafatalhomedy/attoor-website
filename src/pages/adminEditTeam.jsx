        ...
        <div className="min-h-screen bg-cream">
            ...
            <form onSubmit={handleSave} className="max-w-2xl mx-auto px-6 py-10 space-y-6">
                ...
                <div className="grid sm:grid-cols-2 gap-4">
                    <div>
                        <label className="block text-sm font-semibold text-charcoal mb-2">Name (English)</label>
                        <input
                            type="text"
                            value={form.name_en || ""}
                    ...
                    <div>
                        <label className="block text-sm font-semibold text-charcoal mb-2">Name (Arabic)</label>
                        <input
                            type="text"
                            dir="rtl"
                            value={form.name_ar || ""}
                ...
                <div className="grid sm:grid-cols-2 gap-4">
                    <div>
                        <label className="block text-sm font-semibold text-charcoal mb-2">Role (English)</label>
                        <input
                            type="text"
                            value={form.role_en || ""}
                    ...
                    <div>
                        <label className="block text-sm font-semibold text-charcoal mb-2">Role (Arabic)</label>
                        <input
                            type="text"
                            dir="rtl"
                            value={form.role_ar || ""}
                ...
                <div className="grid sm:grid-cols-2 gap-4">
                    <div>
                        <label className="block text-sm font-semibold text-charcoal mb-2">Bio (English)</label>
                        <textarea
                            rows="3"
                            value={form.bio_en || ""}
                    ...
                    <div>
                        <label className="block text-sm font-semibold text-charcoal mb-2">Bio (Arabic)</label>
                        <textarea
                            rows="3"
                            dir="rtl"
                            value={form.bio_ar || ""}
