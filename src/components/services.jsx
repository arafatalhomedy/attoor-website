...
export default function Services() {
    ...
    if (loading) {
        return (
            <section id="services" className="relative bg-cream dark:bg-[#0a0a0a] py-24 transition-colors duration-300">
    ...
    const visibleServices = services.slice(page * PAGE_SIZE, page * PAGE_SIZE + PAGE_SIZE);
                ...
                <div className="relative">
                    ...
                    <div className="grid md:grid-cols-3 gap-8">
                        {visibleServices.map((service) => {
                            ...
                            const Icon = serviceIcons[service.icon_name] || serviceIcons.Building2;

                            return (
                                <div
                                    key={service.id}
                                    className="bg-white/95 dark:bg-zinc-900/95 rounded-xl p-6 border border-zinc-200 dark:border-zinc-800 hover:border-gold hover:scale-105 hover:shadow-xl transition-all duration-300"
                                >
                                    <div className="w-12 h-12 rounded-full bg-gold/10 dark:bg-gold/20 flex items-center justify-center mb-4">
